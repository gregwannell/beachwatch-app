...
export function TopLitterMaterialCard({ materialBreakdown }: TopLitterMaterialCardProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-mcs-ink to-mcs-navy rounded-2xl border border-white/10 p-6 min-h-[12rem] flex flex-col justify-between relative overflow-hidden">
      <Image
      ...
      <div className="relative z-10">
        <div className="flex items-center justify-between mb-2">
          <p className="text-l font-bold text-white leading-tight">{topMaterial.material}</p>
